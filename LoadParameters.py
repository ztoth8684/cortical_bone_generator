...
def LoadParameters(param_file = None):
    ...
    return option, TargetPorosity, export, mu, sigma, weighting, \
        shape_proportions, pores_before_networking, top_branches, \
            bottom_branches, sealed_osteon_chance, transverse_flag_onset